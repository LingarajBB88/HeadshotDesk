    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: "Removing individual slots", def: "Hover an open slot in the Bookings grid and click the small x to take it off the schedule, for example around a meeting nobody told you about. Removed slots are listed under the grid; click one to restore it. Booked slots can't be removed directly: move or clear the booking from the Participants table first." },
        ],
      },
      {
        id: "participant-side",
